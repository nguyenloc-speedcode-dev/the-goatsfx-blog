...
import { DribbbleIcon, FacebookIcon, GithubIcon, InstagramIcon, LinkedinIcon, MoonIcon, SunIcon, Telegram, TiktokIcon, TwitterIcon, YoutubeIcon } from "../Icons";
...
const Header = () => {
  ...
  return (
    <header className="w-full p-4  px-5 sm:px-10 flex items-center justify-between">
      ...
      <nav className=" w-max py-3 px-8  border-dark rounded-full font-medium capitalize  items-center hidden sm:flex
      ...
      <div className=" hidden sm:flex items-center">
        ...
        <a href={siteMetadata.facebook} rel="noopener noreferrer" className="inline-block w-6 h-6 mr-4" aria-label="Reach out to me via LinkedIn" target="_blank"><FacebookIcon className="hover:scale-125 transition-all ease duration-200" /></a>
        <a href={siteMetadata.tiktok} rel="noopener noreferrer" className="inline-block w-6 h-6 mr-4" aria-label="Reach out to me via Twitter" target="_blank"><TiktokIcon className="hover:scale-125 transition-all ease duration-200" /></a>
